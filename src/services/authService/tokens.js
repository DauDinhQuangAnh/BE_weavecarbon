...
const generateAccessToken = (userId, email, roles, companyId = null, isDemo = false) => {
  return jwt.sign(
    {
      sub: userId,
      type: 'access',
...
const generateRefreshToken = (userId, rememberMe = true) => {
  return jwt.sign(
...
const generateCompanyInviteToken = ({ email, companyId }) => {
  return jwt.sign(
    {
